...
hypf_opt = minimize(hypf,@gp,options.GPnumIter,inffunc,meanfunc,covfunc,likfunc,X_train_SoD,y_train_SoD);

[y_train_SoD_pred, ~, ~, s2f_train_SoD] = gp(hypf_opt,inffunc,meanfunc,covfunc,likfunc,X_train_SoD,y_train_SoD,X_train_SoD);
y_train_SoD_noise=(y_train_SoD - y_train_SoD_pred).^2;
mean_noise=mean(y_train_SoD_noise);
y_train_SoD_noise(y_train_SoD_noise==0)=mean_noise;
y_train_SoD_noise = log(y_train_SoD_noise);
%%%
...
hypg_opt = minimize(hypg,@gp,options.GPnumIter,inffunc,meanfunc,covfunc,likfunc,X_train_SoD,y_train_SoD_noise_norm);
...
mu0            = 0; %hypg_opt.mean*std(y_train_SoD_noise) + mean(y_train_SoD_noise);
